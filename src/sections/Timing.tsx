...
const Timing = () => {
  return (
    <section id="timing" className="px-4 mt-44">
        <Animated scale={0.8} className="w-full max-w-5xl h-162.75 rounded-3xl mx-auto bg-cover bg-center flex items-center justify-center md:justify-start px-6 md:px-14 overflow-hidden bg-[url('src/assets/restro-timing.png')]">
